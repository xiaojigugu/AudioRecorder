...
public class LineProgressBar extends View {
    ...
    public LineProgressBar(Context context, @androidx.annotation.Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LineProgressBar(Context context, @androidx.annotation.Nullable AttributeSet attrs, int defStyleAttr) {
